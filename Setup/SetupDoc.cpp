...
void CSetupDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CSetupDoc::InitializeSearchContent()
{
...
void CSetupDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
